...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[2,5],$V1=[1,9],$V2=[1,13],$V3=[1,17],$V4=[2,9],$V5=[1,16],$V6=[5,6],$V7=[7,10,21],$V8=[2,7,10,14,21],$V9=[1,46],$Va=[2,21],$Vb=[1,39],$Vc=[1,35],$Vd=[1,36],$Ve=[1,37],$Vf=[1,38],$Vg=[1,40],$Vh=[1,41],$Vi=[1,42],$Vj=[1,43],$Vk=[1,44],$Vl=[1,45],$Vm=[2,6,8,14,25,26,27,28,29,30,31,32,33],$Vn=[1,52];
