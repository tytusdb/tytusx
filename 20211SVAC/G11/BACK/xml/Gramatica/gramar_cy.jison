...
raices : raices raiz       { $$ = new Node_tree('raices',''); $$.addChild($1); $$.addChild($2); }
       | raiz              { $$ = new Node_tree('raices',''); $$.addChild($1); }
       ;
...
atributos : atributos atributo                           { $$ = new Node_tree('atributos',''); $$.addChild($1); $$.addChild($2); }
          | atributo                                     { $$ = new Node_tree('atributos',''); $$.addChild($1); } 
          ;
...
list_text_elemento : list_text_elemento tipo            { $$ = new Node_tree('list_text_elemento',''); $$.addChild($1); $$.addChild($2); }
                   | tipo                               { $$ = new Node_tree('list_text_elemento',''); $$.addChild($1); }
                   ;
