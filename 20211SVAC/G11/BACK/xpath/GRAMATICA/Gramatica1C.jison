...
BARRAS: TK_BARRA_VERTICAL   { $$ = new Nodo_Tree('BARRAS'); $$.addChild(new Nodo_Tree($1,'TK_BARRA_VERTICAL')); }
    |TK_AND                 { $$ = new Nodo_Tree('BARRAS'); $$.addChild(new Nodo_Tree($1,'TK_AND')); }
    |TK_OR                  { $$ = new Nodo_Tree('BARRAS'); $$.addChild(new Nodo_Tree($1,'TK_OR')); }
    ;
...
ATRIBUTO: TK_DBARRA TK_ARROBA TK_POR L_ATRIBUTO             { $$ = new Node('ATRIBUTO'); $$.addChild(new Node($1,'TK_DBARRA')); $$.addChild(new Node($2,'TK_ARROBA')); $$.addChild(new Nodo_Tree($3,'TK_POR')); $$.addChild($4); }
    |TK_BARRA TK_ARROBA TK_POR L_ATRIBUTO                   { $$ = new Node('ATRIBUTO'); $$.addChild(new Node($1,'TK_BARRA'));  $$.addChild(new Node($2,'TK_ARROBA')); $$.addChild(new Nodo_Tree($3,'TK_POR')); $$.addChild($4); } 
...
ASTERISCO1:TK_CORCHETE_IZQUIERDO EXP TK_CORCHETE_DERECHO    { $$ = new Node('ASTERISCO1'); $$.addChild(new Node($1,'TK_CORCHETE_IZQUIERDO')); $$.addChild($2); $$.addChild(new Node($3,'TK_CORCHETE_IZQUIERDO')); }
...
PAL_RE: PR TK_DDP OPCION { $$ = new Node('PAL_RE'); $$.addChild($1); $$.addChild(new Node($1,'TK_DDP')); $$.addChild($3); };
