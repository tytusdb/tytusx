...
const GreatThan = function ( eIzq , eDer,errorList ,line, column ){
    this.eIzq = eIzq ;
    this.eDer = eDer;
...
GreatThan.prototype.execute = function(Entorno){
...
GreatThan.prototype.getDot = function(){
