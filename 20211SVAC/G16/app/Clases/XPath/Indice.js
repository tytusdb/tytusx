        ...
        if (contenido.pred == "false") {
            ...
            if (pred.pred != undefined) {
                if (pred.pred == "menor") {
                    ...
                    var w = consulta_9.Igual(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                    ...
                    var consulta_10 = new ConsultasTS_js_1.ConsultasTS();
                    var w = consulta_10.Diferente(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                    ...
                    var consulta_11 = new ConsultasTS_js_1.ConsultasTS();
                    var w = consulta_11.Menor(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                    ...
                    var consulta_12 = new ConsultasTS_js_1.ConsultasTS();
                    var w = consulta_12.Menori(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                    ...
                    var consulta_13 = new ConsultasTS_js_1.ConsultasTS();
                    var w = consulta_13.Mayor(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                    ...
                    var consulta_14 = new ConsultasTS_js_1.ConsultasTS();
                    var w = consulta_14.Mayori(pred.id.indice, pred.id.tope, entornotmp);
                    if (w.length == 1) {
                        localStorage.setItem("dad", JSON.stringify(w));
                    }
                    else {
                ...
                var consulta_15 = new ConsultasTS_js_1.ConsultasTS();
                var w = consulta_15.getPredicado(entornotmp, pred);
                localStorage.setItem("dad", JSON.stringify(w));
                //Guardando el padre anterior
                try {
                    localStorage.setItem("dadant", JSON.stringify(padre));
