...
CONTENIDO:
            ENCABEZADO ELEMENTO ACCIONWHE ACCIONOBY ACCIONRET
            |ENCABEZADO ELEMENTO ACCIONWHE ACCIONRET 
            |ENCABEZADO ELEMENTO ACCIONOBY ACCIONRET 
...
LISTAWHE:
         ESTIMACIONAND EXPRESION LISTAWHE
        |EXPRESION
;
...
LISTAOBY:
         ESTIMACIONAND EXPRESION LISTAOBY
        |EXPRESION
;
