"use strict";
class Multiplicacion extends ExpresionAncestor {
    ...
    getTipo(tsXquery, ent) {
        ...
        if (tipoIzquierda.esNumero() && tipoDerecha.esNumero()) {
            ...
            ListaErrores.AgregarErrorXQUERY(CrearError.tiposInvalidos("Multiplicación", tipoIzquierda, tipoDerecha, this.linea, this.columna));
        }
        return tipo;
    }
    ...
    traducir3DXQuery(sizeScope) {
        ...
        if (resultadoIzq != null && resultadoDer != null &&
            ...
            CodeUtil.printWithComment(cadena, "operacion aritmetica de multiplicacion ");
