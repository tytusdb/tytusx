class CodeUtil{
    ...
    public static registrarTamañoHeapCargaXML(size:string){
        this.printWithComment(this.TMP_SIZE_TS_XML+" = "+size+" ;",
            "Guardamos posicion de H para determinar tamaño de la carga");
    }

    public static generarDefinicionFunciones(){
        CodeUtil.print("/*************************************/");
    ...
    public static guardarTexto(cadena:string):string{
    ...
    public static comenzarPrograma(){
        CodeUtil.crearMain();
    }

    public static finalizarProgrma(){
        CodeUtil.cerrarMain();
    ...
    public static genPrintLnString(){
        this.print("/**************************************");
    ...
    public static imprimrObjeto(){
        ...
        this.printWithComment(tmpPosValorAtributo + " = " + tmpParametro1 +" + " + TsRow.POS_INIT_CHILDS + " ;",
            "Posicion del apuntador del valor del atributo");
    ...
    public static imprimirAtributos(){
        this.print("/**************************************");
        ...
        this.printWithComment(tmpPosTamañoObjeto + " = "+tmpParametro1+" + "+TsRow.POS_SIZE + " ;",
            "Obtenemos la posicion donde se guarda el tamaño de objeto");
        var tmpTamañoObjeto = this.generarTemporal();
        this.printWithComment(tmpTamañoObjeto + " = Heap[(int)"+tmpPosTamañoObjeto+"] ;",
    ...
    public static imprimirAtributo(){
        this.print("/**************************************");
    ...
    public static imprimirHijos(){
        ...
        this.print("Stack[SP] = "+tmpHijo+";");
        let tmpParametro2 = this.generarTemporal();
        this.printWithComment(tmpParametro2 + " = SP + 1 ;",
            "Parametro para imprimir atributos.");
    ...
    public static guardarTemporales(tmpMenor:string, tmpMayor:string){
        let inicio:number = +(tmpMenor.replace(this.T,""));
        let final:number = +(tmpMayor.replace(this.T,""));
    ...
    public static recuperarTemporales(tmpMenor:string, tmpMayor:string){
        let inicio:number = +(tmpMenor.replace(this.T,""));
        let final:number = +(tmpMayor.replace(this.T,""));
    ...
    public static imprimirListaObjetos(){
        this.print("/**************************************");
        ...
        this.printWithComment(tmpPosRefeSiguienteObjeto + " = " + tmpParametro1 + " + 1 ;",
            "Obtenemos la referencia del siguiente objeto de la lsita");
        let tmpRefSiguienteObjeto = this.generarTemporal();
        this.printWithComment(tmpRefSiguienteObjeto + " = Heap[(int)"+tmpPosRefeSiguienteObjeto+"] ;",
            "Obtenemos la referncia del siguiente objeto");
        this.printWithComment("if ( "+tmpRefSiguienteObjeto+" == -1 ) goto "+lFin + " ;","Si no hay ningun otro objeto finalizamos")
        this.printWithComment("Stack[(int)"+tmpPostParametro1+"] = "+tmpRefSiguienteObjeto + ";",
            "Colocamos el siguiente objeto en la posicion del parametro y comenzamos la funcion");
