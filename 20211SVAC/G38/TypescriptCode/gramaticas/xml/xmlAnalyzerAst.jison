...
LISTA_TAGS      : LISTA_TAGS TAG 
                ...
                | LISTA_TAGS error
				 {{
                    ...
                    var cadenaRoot=nombreRoot+"["+'label="LISTA_TAGS",'+'color="lightblue3",'+"];\n ";
					//childs
                    var nombreError = XpathUtil.generarIdUnicoXmlNode();
                    var cadenaError=nombreMayor+"["+'label="Error",'+'color="red",'+"];\n ";

					//RESULTADO
					var cad = cadenaRoot + $1["cad"]+ cadenaError       ;
					cad+=nombreRoot+"->"+$1["nombre"]+";\n";
					cad+=nombreRoot+"->"+nombreError+";\n"; 
				...
				{{
                    ...
                    var nombreError = XpathUtil.generarIdUnicoXmlNode();
                    var cadenaError=nombreError+"["+'label="ERROR",'+'color="red",'+"];\n ";
					//RESULTADO
					var cad = cadenaRoot + cadenaError   ;
					cad+=nombreRoot+"->"+nombreError+";\n";
