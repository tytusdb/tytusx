...
case 4:
					...
					//RESULTADO
					var cad = cadenaRoot + $$[$0-1]["cad"]+ cadenaError       ;
					cad+=nombreRoot+"->"+$$[$0-1]["nombre"]+";\n";
...
exports.parser = xmlAnalyzerAst;
exports.Parser = xmlAnalyzerAst.Parser;
exports.parse = function () { return xmlAnalyzerAst.parse.apply(xmlAnalyzerAst, arguments); };
