...
export class ManejadorXquery {
    ...
    static graficarXquery (listNodes: Retorno[]) : string{

        var content : string [] = []
        for (const element of listNodes) {
            
            if (element.type === tipoPrimitivo.NODO){
                ManejadorXquery.concatenar(content, this.graficarNodos(element.value, ""));
            }else {
    ...
    static graficarNodos(entPadre: Entorno, tab : string): string [] {
