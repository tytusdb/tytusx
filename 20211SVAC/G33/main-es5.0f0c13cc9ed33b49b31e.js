    ...
    var CST = /*#__PURE__*/function () {
      ...
      _createClass(CST, [{
        ...
        value: function generarNodoObjeto(objeto, pos, padre) {
          ...
          var nodo = "nodo".concat(pos, " [shape=plaintext ") + "label=<" + "<table border=\"0\" cellborder=\"1\" cellspacing=\"0\">" + "<tr><td bgcolor=\"red\">ETIQUETA</td></tr>" + "<tr><td bgcolor=\"lightblue\">".concat(objeto.identificador, "</td></tr>") + "</table>> ]\n";
          ...
          if (objeto.texto !== '') {
            nodo += "nodo".concat(pos, "_t [shape=record label =\"").concat(objeto.texto, "\" ]\n");
        ...
        value: function generarNodoAtributo(objeto, pos, padre) {
          ...
          var nodo = "nodo".concat(pos, " [shape=plaintext ") + "label=<" + "<table border=\"0\" cellborder=\"1\" cellspacing=\"0\">" + "<tr><td bgcolor=\"yellow\">ATRIBUTO</td></tr>" + "<tr><td bgcolor=\"lightblue\">".concat(objeto.identificador, "</td></tr>") + "</table>> ]\n";
          nodo += "nodo".concat(padre, " -> nodo").concat(pos, "\n");
          nodo += "nodo".concat(pos, "_a [shape=box label=").concat(objeto.valor, "]\n");
    ...
    var TablaSimbolos = /*#__PURE__*/function () {
      ...
      _createClass(TablaSimbolos, [{
        ...
        value: function generarReporteTablaObjetos(objetos) {
          ...
          objetos.forEach(function (object) {
            _this3.cuerpoHtml += _this3.generarFilaObjeto(object, null, 1, 'ETIQUETA');
          });
          this.cuerpoHtml += "    </tbody> \n";
        ...
        value: function generarFilaObjeto(objeto, ambito, posicion, tipo) {
          var _this4 = this;

          var fila = "  <tr> \n";
          fila += "      <td class=\"text-left\">".concat(posicion, "</td>\n");
          fila += "      <td class=\"text-left\">".concat(objeto.identificador, "</td>\n");
          fila += "      <td class=\"text-left\">".concat(tipo, "</td>\n");

          if (objeto.texto === '') {
            fila += "      <th class=\"text-left\"> Etiqueta Raiz </th>\n";
          } else {
            fila += "      <td class=\"text-left\">".concat(objeto.texto, "</td>\n");
          }

          fila += "        <th>".concat(objeto.linea, "</th> \n");
          fila += "        <th>".concat(objeto.columna, "</th> \n");

          if (ambito === null) {
            fila += "      <th class=\"text-left\">GLOBAL</th>\n";
          } else {
            fila += "      <td class=\"text-left\">".concat(ambito, "</td>\n");
          }

          fila += "  </tr> \n";
          objeto.listaAtributos.forEach(function (atribute) {
            fila += _this4.generarFilaAtributo(atribute, objeto.identificador, posicion + 1, 'ATRIBUTO');
          });
          objeto.listaObjetos.forEach(function (atribute) {
            fila += _this4.generarFilaObjeto(atribute, objeto.identificador, posicion + 1, 'ETIQUETA');
          });
          return fila;
        }
      }, {
        key: "generarFilaAtributo",
        value: function generarFilaAtributo(objeto, ambito, posicion, tipo) {
          var fila = "  <tr> \n";
          fila += "      <td class=\"text-left\">".concat(posicion, "</td>\n");
          fila += "      <td class=\"text-left\">".concat(objeto.identificador, "</td>\n");
          fila += "      <td class=\"text-left\">".concat(tipo, "</td>\n");
          fila += "      <td>".concat(objeto.valor, "</td>\n");
          fila += "      <td>".concat(objeto.linea, "</td> \n");
          fila += "      <td>".concat(objeto.columna, "</td> \n");
          fila += "      <td class=\"text-left\">".concat(ambito, "</td>\n");
          fila += "  </tr> \n";
          return fila;
        }
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ejecutarAscendente() {
          ...
          var retorno = ascXML.ejecutarCodigo(this.xmlEntrada);
          console.log(retorno);
        }
      }]);
...
//# sourceMappingURL=main-es5.0f0c13cc9ed33b49b31e.js.map