...
exports.optimizadorC = void 0;
const asign_1 = require("./asign");
const comando_1 = require("./comando");
class optimizadorC {
    constructor(raiz) {
        this.reglas = new Array();
        this.comandos = new Array();
        this.asignaciones = new Array();
        this.raiz = raiz;
    ...
    recorrer(nodo) {
        ...
        if (this.soyNodo('GOTO', nodo)) {
            this.comandos.push(new comando_1.comando(nodo.hijos[0], nodo.linea, true));
        ...
        if (this.soyNodo('LABEL', nodo)) {
            ...
            this.comandos.push(new comando_1.comando(nodo.hijos[0], nodo.linea, false));
            return nodo.hijos[0] + `:\n`;
        }
        //                  FUNCIONES
   ...
   */
    ...
    Reglas6_16(nodoD, nodo) {
        ...
        if (nodo.hijos.length < 3) {
            ...
            if (isNaN(valor) && nodo.hijos.length == 1) {
                this.asignaciones.push(new asign_1.asign(id, this.recorrer(nodo), nodo.linea));
            }
    ...
    recortarStringContrario(s, de, a) {
        if (a > de) {
...
exports.optimizadorC = optimizadorC;
