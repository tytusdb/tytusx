...
S
  :  INSTRUCCIONES  EOF { 
var regla = new regla_1.reglaGramatical({ produccion: 'S → INSTRUCCIONES EOF', regla:'return new NodoAST({label: \'/\', hijos: [$1])' });
...
var regla = new regla_1.reglaGramatical({ produccion: 'INSTRUCCIONES → INSTRUCCION INSTRUCCIONES', regla:'$$ = new NodoAST({label: \'OBJETOS\', hijos: [...$1.hijos,$2]})' });
reporte_1.ReporteGramatical.getInstance().push(regla);  
  $$ = new NodoAST({label: 'OBJETOS', hijos: [...$2.hijos,$1], linea: yylineno});
  }
             | INSTRUCCION {
var regla = new regla_1.reglaGramatical({ produccion: 'INSTRUCCIONES → INSTRUCCION', regla:'$$ = new NodoAST({label: \'OBJETOS\', hijos: [$1], linea: yylineno})' });
reporte_1.ReporteGramatical.getInstance().push(regla);
...
var regla = new regla_1.reglaGramatical({ produccion: 'INSTRUCCION → menor id ATRIBUTOS mayor INSTRUCCIONES menor div id mayor', regla:'$$ = new NodoAST({label: \'OBJETO\', hijos: [new NodoAST({label:$2, hijos:[$3,...$5.hijos], linea:yylineno})], linea: yylineno});' });
reporte_1.ReporteGramatical.getInstance().push(regla);
...
reporte_1.ReporteGramatical.getInstance().push(regla);
              const rex=/[\ ]{2,}/g;
              const rex2=/[\n]{2,}/g;
              $1=$1.replace(/[\t]+/g,"").replace(rex, "").replace(rex2,"");
...
var regla = new regla_1.reglaGramatical({ produccion: 'ATRIBUTOS → ATRIBUTO ATRIBUTOS', regla:'$$ = new NodoAST({label: $1.label, hijos: [...$1.hijos, ...$2.hijos], linea: yylineno});' });
reporte_1.ReporteGramatical.getInstance().push(regla);
