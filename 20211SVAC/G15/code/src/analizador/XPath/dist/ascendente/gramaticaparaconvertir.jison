...
XPATH: BLOQUE EOF    {   
		       ...
		       $$.addHijos($1);
                     arreglolexico=$1;
                     return { codigo:arreglolexico,finalizado:"\nfin.",diagramaAST:$$};
                     };



BLOQUE:PATHRELL1 SIMPLEOR          { 
                                   $$ = new Nodo("BLOQUE","EXPRESION");
                                   $$.addHijos($1);
                                   $$.addHijos($2);  
                                   }  //push   
   |PATHRELL1                      { 
...
SIMPLEOR: SIMPLEOR ORL2            { 
                                   $$ = new Nodo("SIMPLEOR","EXPRESION");
                                   $$.addHijos($1);
                                   $$.addHijos($2);  
                                   } 
       |ORL2                       { 
...
ORL2: simpleor PATHRELL1           { 
                                   $$ = new Nodo($1,"ORL2");
                                   $$.addHijos($2); 
                                   }    //INSTRUCCION     // new simpleor
       ;


/*SIMPLEOR: PATHRELL1 ORL1        {$$= new SOR($1,$2,@1.first_line, @1.first_column);}//INSTRUCCION     //new OR(RUTA1,RUTA2,linea,columna)
       ;
...
ORL2: simpleor PATHRELL1        {$$= new Path($2,@1.first_line, @1.first_column);}//INSTRUCCION     // new simpleor
       ;*/
