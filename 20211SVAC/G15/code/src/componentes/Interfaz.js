	...
	MetodoXML = (event) => {
		...
		//-------------Descendente
			...
			if(texto==""){
				...
				RespuestaXML=AnalizadorXmlAsc.analizarXML(texto);
				alert("Analisis Terminado")
				document.getElementById("ConsolaSalida").value =RespuestaXML;//objetos.codigo
		        ...
		        <div className="container">
							...
							<tr>
								<td>
									<select native name ="Menu_XML" class="Menu_XML" id="Menu_XML" onChange={this.MetodoXML} >
                            			...
                            			<option value = "Menu_DesXmML" >Analizar Descendente</option>
					   ...
					   <table className="tablageneral" id="tablageneral" name="tablageneral">
						   ...
						   <div className="GraphizDiv">
								   <center>
								   		<Graphviz dot={this.state.dot} options={{zoom:true,width:1200,height:1200}} />
								   </center>
