...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,13],$V1=[1,5],$V2=[1,6],$V3=[1,8],$V4=[1,9],$V5=[1,10],$V6=[1,11],$V7=[1,12],$V8=[2,3],$V9=[1,15],$Va=[6,7],$Vb=[2,17,18,19,21,22,62,63,64,65,66,67,69,70,71],$Vc=[6,7,15,16],$Vd=[1,20],$Ve=[1,21],$Vf=[1,22],$Vg=[1,32],$Vh=[1,38],$Vi=[1,33],$Vj=[1,34],$Vk=[1,35],$Vl=[1,36],$Vm=[1,37],$Vn=[1,39],$Vo=[1,40],$Vp=[6,7,15,16,22,45,46,47],$Vq=[1,50],$Vr=[1,49],$Vs=[1,46],$Vt=[1,45],$Vu=[1,47],$Vv=[1,48],$Vw=[1,52],$Vx=[1,53],$Vy=[1,54],$Vz=[1,55],$VA=[1,56],$VB=[2,9],$VC=[1,68],$VD=[1,69],$VE=[31,32],$VF=[1,81],$VG=[1,79],$VH=[1,80],$VI=[1,82],$VJ=[26,31,32],$VK=[2,26],$VL=[22,31,32,35,36,37,38,39,40,45,46,47],$VM=[31,32,35,36,37,38,39,40],$VN=[2,40];
...
case 44:return 6;
break;
case 45:console.log(yy_.yytext,"ErroreLexico")
break;
}
},
