...
*/
var xpathD = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[1,8],$V2=[1,9],$V3=[1,6],$V4=[2,4],$V5=[1,12],$V6=[5,8],$V7=[2,5,8,11,12,13],$V8=[13,16,19,20,21];
...
case 46:return 5
break;
case 47:new ControlError(yy_.yytext, TipoSeleccion.ERROR_LEXICO, yy_.yylloc.first_line,yy_.yylloc.first_column,"XpathDescendente")
break;
}
},
