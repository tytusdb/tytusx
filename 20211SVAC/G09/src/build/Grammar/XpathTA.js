...
var XpathTA = (function () {
    var o = function (k, v, o, l) { for (o = o || {}, l = k.length; l--; o[k[l]] = v)
        ; return o; }, $V0 = [1, 12], $V1 = [1, 4], $V2 = [1, 5], $V3 = [1, 7], $V4 = [1, 8], $V5 = [1, 9], $V6 = [1, 10], $V7 = [1, 11], $V8 = [2, 13, 14, 15, 17, 18, 51, 52, 53, 54, 55, 56, 58, 59, 60], $V9 = [8, 11, 12], $Va = [1, 17], $Vb = [1, 18], $Vc = [1, 19], $Vd = [8, 11, 12, 18, 22, 23, 24, 27, 28, 29, 30, 31, 32, 33, 34, 35], $Ve = [1, 44], $Vf = [1, 41], $Vg = [1, 40], $Vh = [1, 42], $Vi = [1, 43], $Vj = [1, 45], $Vk = [1, 47], $Vl = [1, 48], $Vm = [1, 49], $Vn = [1, 50], $Vo = [1, 51], $Vp = [22, 23, 24], $Vq = [1, 68], $Vr = [1, 66], $Vs = [1, 67], $Vt = [1, 69], $Vu = [18, 22, 23, 24, 27, 28, 29, 30, 31, 32, 33, 34, 35], $Vv = [22, 23, 24, 27, 28, 29, 30, 31, 32, 33, 34];
