...
*/
var xmlA = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,8],$V1=[1,9],$V2=[1,15],$V3=[2,6,12,15],$V4=[1,19],$V5=[14,17,19,21],$V6=[2,10,12,15],$V7=[2,12];
...
productions_: [0,[3,3],[3,2],[5,2],[5,1],[7,3],[7,3],[7,2],[7,1],[7,2],[8,3],[8,2],[9,2],[11,3],[11,2],[4,3],[13,2],[13,1],[20,3]],
...
case 9:
       ...
       console.log('Sintactico', `Error recuperado con ${yytext}`, this._$.first_line, this._$.first_column);
...
table: [{2:$V0,3:1,4:2,5:3,7:5,8:6,11:7,12:$V1,18:[1,4]},{1:[3]},{2:$V0,5:10,7:5,8:6,11:7,12:$V1},{2:$V0,6:[1,11],7:12,8:6,11:7,12:$V1},{13:13,20:14,21:$V2},o($V3,[2,4]),{2:$V0,5:16,7:5,8:6,9:18,10:[1,17],11:7,12:$V1,15:$V4},o($V3,[2,8]),{12:[1,20]},{13:21,14:[1,22],17:[1,23],20:14,21:$V2},{2:$V0,6:[1,24],7:12,8:6,11:7,12:$V1},{1:[2,2]},o($V3,[2,3]),{19:[1,25],20:26,21:$V2},o($V5,[2,17]),{22:[1,27]},{2:$V0,7:12,8:6,9:28,11:7,12:$V1,15:$V4},{9:29,15:$V4},o($V3,[2,7]),{16:[1,30]},o($V3,[2,9]),{14:[1,31],17:[1,32],20:26,21:$V2},o($V6,[2,11]),o($V3,[2,14]),{1:[2,1]},o($V7,[2,15]),o($V5,[2,16]),{23:[1,33]},o($V3,[2,5]),o($V3,[2,6]),o($V3,$V7),o($V6,[2,10]),o($V3,[2,13]),o($V5,[2,18])],
...
case 4:
break;
case 5: this.begin("TagApertura"); return 18; 
break;
case 6:
break;
case 7: return 21; 
...
break;
case 17: this.popState();  return 17; 
break;
case 18: this.begin("TagCierre"); return 15 
break;
case 19: this.popState(); return 16 
break;
case 20:
break;
case 21: return 10; 
