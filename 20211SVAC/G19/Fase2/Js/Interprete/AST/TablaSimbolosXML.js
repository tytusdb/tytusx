        ...
        objetos.forEach(function (element) {
            ...
            if (element.listaAtributos.length > 0) {
                element.listaAtributos.forEach(function (atributo) {
                    var simbolo = new Simbolo(Tipo.ATRIBUTO, atributo.identificador, atributo.linea, atributo.columna, atributo.valor,atributo.posicion,atributo.posicionH);
            ...
            var simbolo = new Simbolo(Tipo.STRUCT, element.identificador1, element.linea, element.columna, element,element.posicion,element.posicionH);
