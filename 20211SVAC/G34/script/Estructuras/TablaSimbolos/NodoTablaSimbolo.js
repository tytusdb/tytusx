...
var NodoTablaSimbolo = /** @class */ (function () {
    function NodoTablaSimbolo(indentificador, valor, tipo, entorno, linea, columna) {
    ...
    NodoTablaSimbolo.prototype.setEntorno = function (entorno) {
        this.entorno = entorno;
    };
    NodoTablaSimbolo.prototype.setValor = function (valor) {
        this.valor = valor;
    };
