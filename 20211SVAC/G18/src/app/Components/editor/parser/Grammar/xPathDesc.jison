...
Lexp : Syntfin Lexp_prima{
			...
			lexp.addHijo($1);
			if($2 != null) lexp.addHijo($2);
			$$ = lexp;
		};
		
Lexp_prima : ORSIGN DIVSIGN Syntfin Lexp_prima{
						var lexp = new NodoXML("Lexp","Lexp",@1.first_line+1,@1.first_column+1);
						var val1 = new NodoXML($1,"Lexp",@1.first_line+1,@1.first_column+1);
						var val2 = new NodoXML($2,"Lexp",@1.first_line+1,@1.first_column+1);						
						lexp.addHijo(val1);
						lexp.addHijo(val2);
						lexp.addHijo($3);
						if($4 != null) lexp.addHijo($4);
						$$ = lexp;
					}
...
LPredicado : Predicado LPredicado_prima{
							...
							if($2 != null) lpredicado.addHijo($2);	
							$$ = lpredicado;
						};
