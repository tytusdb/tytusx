...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppComponentsAstAstComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AstComponent", function () {
      return AstComponent;
    });
    /* harmony import */
    ...
    var vis__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! vis */
    "./node_modules/vis/dist/vis.js");
    /* harmony import */


    var vis__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(vis__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */


    var _services_dot_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/dot.service */
    "./src/app/services/dot.service.ts"); // Import para las graficas


    var AstComponent = /*#__PURE__*/function () {
      function AstComponent(dotService) {
        _classCallCheck(this, AstComponent);

        this.dotService = dotService;
      }

      _createClass(AstComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var dotRes = this.dotService.getDot(); //alert(dotRes);
    ...
    AstComponent.ɵfac = function AstComponent_Factory(t) {
      return new (t || AstComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_dot_service__WEBPACK_IMPORTED_MODULE_2__["DotService"]));
    };

    AstComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AstComponent,
      selectors: [["app-ast"]],
      decls: 18,
      vars: 0,
      consts: [["role", "main", 1, "content"], [1, "container-fluid"], [1, "row"], [1, "col-md-12", "text-center"], [1, "title"], ["id", "graph", 1, "col-md-12", "text-center"]],
      template: function AstComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AstComponent, [{
        ...
        return [{
          type: _services_dot_service__WEBPACK_IMPORTED_MODULE_2__["DotService"]
        }];
      }, null);
    })();
    /***/
  ...
  function srcAppComponentsEditorEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _parser_Util_Salida__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./parser/Util/Salida */
    "./src/app/Components/editor/parser/Util/Salida.ts");
    /* harmony import */


    var _parser_Report_plotter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./parser/Report/plotter */
    "./src/app/Components/editor/parser/Report/plotter.ts");
    /* harmony import */


    var _parser_Report_Table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./parser/Report/Table */
    ...
    var _parser_Errores__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./parser/Errores */
    "./src/app/Components/editor/parser/Errores.ts");
    /* harmony import */


    var _services_dot_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../services/dot.service */
    ...
    /*! @angular/forms */
    "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js"); // Imports para los reportes
    ...
    var parserXML = __webpack_require__(
    /*! ./parser/Grammar/XmlGrammarASC.js */
    "./src/app/Components/editor/parser/Grammar/XmlGrammarASC.js");

    var EditorComponent = /*#__PURE__*/function () {
      function EditorComponent(dotService) {
        _classCallCheck(this, EditorComponent);

        this.dotService = dotService; // Variables
      ...
      _createClass(EditorComponent, [{
        ...
        value: function cOutput(body) {
          ...
          for (var index = 0; index < _parser_Util_Salida__WEBPACK_IMPORTED_MODULE_1__["_Console"].count; index++) {
          ...
          this.salida = _parser_Util_Salida__WEBPACK_IMPORTED_MODULE_1__["_Console"].count != 0 ? this.salida.substring(0, this.salida.length - 2) : this.salida + 't0';
          this.salida += ';\n\n';
        ...
        key: "executeOpt",
        value: function executeOpt(entrada) {// try {
        ...
        key: "optimizar",
        value: function optimizar() {// Swal.fire({
        ...
        key: "ejecutar",
        value: function ejecutar() {// this.clean();
          // try {
          //   this.ast = parserXML.parse(this.entradaXml.toString());
          //   console.log(this.ast);
          // } catch (e) {
        ...
        key: "translate",
        value: function translate() {// this.clean();
          // try {
        ...
        key: "newXML",
        value: function newXML() {
          //New File
          this.entradaXml = '';
        }
      }, {
        key: "newXPath",
        value: function newXPath() {
          //New File
          this.entradaXpath = '';
        }
      }, {
        key: "openXML",
        value: function openXML() {
          var _this = this;
          ...
          fileSelector.onchange = function (e) {
            ...
            reader.addEventListener('load', function (event) {
              _this.entradaXml = event.target.result.toString();
            });
            reader.readAsText(file);
          };
        ...
        value: function openXPath() {
          ...
          fileSelector.onchange = function (e) {
            ...
            var reader = new FileReader();
            reader.addEventListener('load', function (event) {
              _this2.entradaXpath = event.target.result.toString();
            });
            reader.readAsText(file);
          };
    ...
    EditorComponent.ɵfac = function EditorComponent_Factory(t) {
      return new (t || EditorComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_dot_service__WEBPACK_IMPORTED_MODULE_7__["DotService"]));
    };

    EditorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: EditorComponent,
      selectors: [["editor-root"]],
      decls: 102,
      vars: 31,
      consts: [["role", "main", 1, "content"], [1, "container-fluid"], [1, "row"], [1, "col-md-12"], ["ngbDropdown", "", 1, "d-inline-block"], ["id", "dropdownBasic1", "ngbDropdownToggle", "", 1, "btn", "btn-dark", 2, "background-color", "rgb(8, 101, 104)"], [3, "icon"], ["ngbDropdownMenu", "", "aria-labelledby", "dropdownBasic1", 1, "btn", "btn-info", "dropdown-toggle", 2, "background-color", "rgb(8, 101, 104)"], ["type", "button", 1, "dropdown-item", 3, "click"], ["type", "button", 1, "btn", "btn-dark", 2, "background-color", "rgb(8, 101, 104)", 3, "click"], [1, "col-md-6"], [1, "terminal"], [1, "term-title"], [3, "ngModel", "options", "ngModelChange"], ["id", "output", 1, "terminal"], ["disabled", "", 3, "ngModel", "options", "ngModelChange"], ["id", "graph", 1, "col-md-12", "text-center"], ["id", "temporal", 2, "display", "none"]],
      template: function EditorComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_9_listener() {
            return ctx.ejecutarXmlAsc();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_12_listener() {
            return ctx.ejecutar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_15_listener() {
            return ctx.newXML();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_18_listener() {
            return ctx.openXML();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_30_listener() {
            return ctx.ejecutar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_33_listener() {
            return ctx.ejecutar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_36_listener() {
            return ctx.newXPath();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_39_listener() {
            return ctx.openXPath();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_42_listener() {
            return ctx.saveXPath();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_46_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_50_listener() {
            return ctx.optimizar();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_59_listener() {
            return ctx.printAst();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_62_listener() {
            return ctx.printAst();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_65_listener() {
            return ctx.printAst();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_68_listener() {
            return ctx.tokenTable();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_71_listener() {
            return ctx.errorTable();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_74_listener() {
            return ctx.optTable();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditorComponent_Template_button_click_78_listener() {
            return ctx.clearConsole();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditorComponent_Template_ngx_codemirror_ngModelChange_87_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditorComponent_Template_ngx_codemirror_ngModelChange_92_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditorComponent_Template_ngx_codemirror_ngModelChange_98_listener($event) {
            return ctx.salida = $event;
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EditorComponent, [{
        ...
        return [{
          type: _services_dot_service__WEBPACK_IMPORTED_MODULE_7__["DotService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppComponentsEditorParserAbstractNodoTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Nodo = function Nodo(name, type, line, column) {
  ...
  /***/
  function srcAppComponentsEditorParserErrorTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Error_", function () {
      return Error_;
    });

    var Error_ = /*#__PURE__*/function () {
      function Error_(linea, columna, tipo, mensaje) {
      ...
      _createClass(Error_, [{
        ...
        key: "htmlRow",
        value: function htmlRow() {
          var result = "<td>" + this.tipo + "</td>";
  ...
  /***/
  function srcAppComponentsEditorParserErroresTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "errores", function () {
      return errores;
    });
  ...
  /***/
  function srcAppComponentsEditorParserGrammarXmlGrammarASCJs(module, exports, __webpack_require__) {
      ...
      */
      var XmlGrammarASC = function () {
        ...
        var parser = {
          ...
          productions_: [0, [3, 3], [3, 2], [5, 3], [5, 2], [7, 3], [7, 4], [7, 3], [7, 4], [13, 4], [13, 3], [8, 2], [8, 1], [9, 4], [9, 4]],
          ...
          /* lstack */
            ...
            switch (yystate) {
              case 1:
                var s = new NodoXML("S", "S", +yylineno + 1, +_$[$0 - 2].first_column + 1, null);
                var dec = new NodoXML("DEC", "DEC", +yylineno + 1, +_$[$0 - 2].first_column + 1, $$[$0 - 2]); // s.addHijo(dec);
                // s.addHijo($$[$0-1]);
              ...
              case 2:
                var s = new NodoXML("S", "S", +yylineno + 1, +_$[$0 - 1].first_column + 1, null); // s.addHijo($$[$0-1]);

                return s;
                break;

              case 3:
                var i = new NodoXML("I", "I", +yylineno + 1, +_$[$0 - 2].first_column + 1, null);
                i.addHijo($$[$0 - 2]);
                i.addHijo($$[$0 - 1]);
                i.addHijo($$[$0]);
                this.$ = i;
              ...
              case 4:
                var i = new NodoXML("I", "I", +yylineno + 1, +_$[$0 - 1].first_column + 1, null);
                i.addHijo($$[$0 - 1]);
                i.addHijo($$[$0]);
                this.$ = i;
                break;
              ...
              case 5:
                this.$ = tag = new NodoXML($$[$0 - 2], "OTAG", +yylineno + 1, +_$[$0 - 2].first_column + 1, null);
                break;

              case 6:
                var tag = new NodoXML($$[$0 - 3], "OTAG", +yylineno + 1, +_$[$0 - 3].first_column + 1, null);
                tag.addHijo($$[$0 - 3]);
                this.$ = tag;
                break;
            }
          ...
          var lexer = {
            ...
            performAction: function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
              ...
              switch ($avoiding_name_collisions) {
                ...
                case 31:
                  errores.push(new Error_(yy_.yylloc.first_line, yy_.yylloc.first_column, "Lexico", "Valor inesperado " + yy_.yytext));
                  console.error(errores);
                  break;
              }
            },
            rules: [/^(?:<\?xml\b)/, /^(?:\?>)/, /^(?:[^(\?>)])/, /^(?:$)/, /^(?:["])/, /^(?:["])/, /^(?:\\n)/, /^(?:\\t)/, /^(?:\\\\)/, /^(?:\\r)/, /^(?:\\")/, /^(?:.)/, /^(?:['])/, /^(?:['])/, /^(?:&lt;)/, /^(?:&gt;)/, /^(?:&amp;)/, /^(?:&apos;)/, /^(?:&quot;)/, /^(?:.)/, /^(?:>[^<])/, /^(?:<)/, /^(?:[^<])/, /^(?:$)/, /^(?:>)/, /^(?:<)/, /^(?:\/)/, /^(?:=)/, /^(?:[[a-zA-ZñÑáéíóúÁÉÍÓÚ]["_""-"0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]*|["_""-"]+[0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]["_""-"0-9a-zA-ZñÑáéíóúÁÉÍÓÚ]*)/, /^(?:[ \t\n\r\f])/, /^(?:$)/, /^(?:.)/],
            conditions: {
              valin: {
                rules: [21, 22, 23],
                inclusive: false
  ...
  /***/
  function srcAppComponentsEditorParserNodesNodoXmlTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NodoXML", function () {
      return NodoXML;
    });
    /* harmony import */


    var _Abstract_Nodo__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ../Abstract/Nodo */
    "./src/app/Components/editor/parser/Abstract/Nodo.ts");

    var NodoXML = /*#__PURE__*/function (_Abstract_Nodo__WEBPA) {
      _inherits(NodoXML, _Abstract_Nodo__WEBPA);

      var _super = _createSuper(NodoXML);

      function NodoXML(id, tipo, line, column, val) {
        var _this3;

        _classCallCheck(this, NodoXML);

        _this3 = _super.call(this, id, tipo, line, column);
        _this3.val = val;
        return _this3;
      }

      _createClass(NodoXML, [{
        key: "plotCst",
        value: function plotCst(count) {
          var result = "node".concat(count, " [label=\"(").concat(this.line, ",").concat(this.column, ") ").concat(this.name, " (").concat(this.type, ")\"];\n");
          this.getHijos().forEach(function (element) {
      ...
      return NodoXML;
    }(_Abstract_Nodo__WEBPACK_IMPORTED_MODULE_0__["Nodo"]);
    /***/
  ...
  /***/
  function srcAppComponentsEditorParserReportTableTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Table = /*#__PURE__*/function () {
      ...
      _createClass(Table, [{
        ...
        value: function rules(_rules) {
          ...
          _rules.forEach(function (element) {
            result += '<tr>\n';
        ...
        key: "symbols",
        value: function symbols(simbolos) {
          var result = '<div class="table-wrapper-scroll-y my-custom-scrollbar">';
          ...
          result += '<tbody>\n';
          var count = 1;
          simbolos.forEach(function (element) {
            result += '<tr>\n';
            result += '<th scope="row">' + count + '</th>\n';
            result += element.htmlRow();
            result += '</tr>\n';
  ...
  /***/
  function srcAppComponentsEditorParserReportPlotterTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "Plotter", function () {
      return Plotter;
    ...
    var Plotter = /*#__PURE__*/function () {
      ...
      _createClass(Plotter, [{
        key: "makeDot",
        value: function makeDot(ast) {
          var count = 1;
          var result = 'digraph AST{ node[shape="box"];';
          result += 'node' + count + '[label="(0,0) Inicio"];';
          result += this.printAST(ast, count); // if (ast != null) {
        ...
        key: "printAST",
        value: function printAST(ast, count) {
          var _this4 = this;
          ...
          if (ast != null) {
            ...
            count++;
            ast.getHijos().forEach(function (element) {
              res += _this4.printAST(element, count);
            });
          }
  ...
  /***/
  function srcAppComponentsEditorParserUtilSalidaTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "_Console", function () {
      return _Console;
    });
    ...
    var Console = /*#__PURE__*/function () {
      ...
      _createClass(Console, [{
        ...
        key: "saveInHeap",
        value: function saveInHeap(index, id) {
          this.heap[index] = id;
        }
      }, {
        key: "saveInStack",
        value: function saveInStack(index, id) {
          this.stack[index] = id;
        }
      }]);
  ...
  function srcAppComponentsFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 0,
      consts: [[1, "page-footer", "font-small", "blue", "pt-4"], [1, "container-fluid", "text-center", "text-md-left"], [1, "row"], [1, "col-md-6", "mt-md-0", "mt-3"], [1, "clearfix", "w-100", "d-md-none", "pb-3"], [1, "footer-copyright", "text-center", "py-3"], ["href", "https://github.com/Xvimnt/Compi2_Junio"]],
      template: function FooterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](10, "\xA9 2021 MIT: ");
  ...
  function srcAppComponentsToolbarToolbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ToolbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [["role", "banner", 1, "toolbar"], ["width", "40", "alt", "Angular Logo", "src", "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.pinimg.com%2Foriginals%2F18%2Fe9%2F84%2F18e98488f4463e3114d7059324ec382c.png&f=1&nofb=1"]],
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Components_ast_ast_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./Components/ast/ast.component */
    "./src/app/Components/ast/ast.component.ts");
    /* harmony import */


    var _Components_editor_editor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./Components/editor/editor.component */
    "./src/app/Components/editor/editor.component.ts");

    var routes = [{
      path: 'ast',
      component: _Components_ast_ast_component__WEBPACK_IMPORTED_MODULE_2__["AstComponent"]
    }, {
      path: 'editor',
      component: _Components_editor_editor_component__WEBPACK_IMPORTED_MODULE_3__["EditorComponent"]
    }, {
      path: '',
      redirectTo: '/editor',
      pathMatch: 'full'
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_Components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_1__["ToolbarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"], _Components_footer_footer_component__WEBPACK_IMPORTED_MODULE_3__["FooterComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Components_ast_ast_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./Components/ast/ast.component */
    "./src/app/Components/ast/ast.component.ts");
    /* harmony import */
    ...
    /*! ./Components/footer/footer.component */
    "./src/app/Components/footer/footer.component.ts"); // Modulos propios
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ctrl_ngx_codemirror__WEBPACK_IMPORTED_MODULE_5__["CodemirrorModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _Components_editor_editor_component__WEBPACK_IMPORTED_MODULE_9__["EditorComponent"], _Components_ast_ast_component__WEBPACK_IMPORTED_MODULE_8__["AstComponent"], _Components_toolbar_toolbar_component__WEBPACK_IMPORTED_MODULE_10__["ToolbarComponent"], _Components_footer_footer_component__WEBPACK_IMPORTED_MODULE_11__["FooterComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ctrl_ngx_codemirror__WEBPACK_IMPORTED_MODULE_5__["CodemirrorModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_7__["FontAwesomeModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppServicesDotServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DotService", function () {
      return DotService;
    });
    /* harmony import */
    ...
    var DotService = /*#__PURE__*/function () {
      function DotService(storage) {
      ...
      _createClass(DotService, [{
        key: "setDot",
        value: function setDot(dot) {
    ...
    DotService.ɵfac = function DotService_Factory(t) {
      return new (t || DotService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_1__["SESSION_STORAGE"]));
    };

    DotService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: DotService,
      factory: DotService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DotService, [{
  ...
  function srcMainTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var codemirror_mode_javascript_javascript__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! codemirror/mode/javascript/javascript */
    "./node_modules/codemirror/mode/javascript/javascript.js");
    /* harmony import */


    var codemirror_mode_javascript_javascript__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_javascript_javascript__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var codemirror_mode_markdown_markdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! codemirror/mode/markdown/markdown */
    "./node_modules/codemirror/mode/markdown/markdown.js");
    /* harmony import */


    var codemirror_mode_markdown_markdown__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(codemirror_mode_markdown_markdown__WEBPACK_IMPORTED_MODULE_3__);
    /* harmony import */
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\matri\OneDrive\Documents\Compi2\Compi2_Junio\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
