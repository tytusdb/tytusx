...
%{
    ...
    const {RepGramatical} = require("../Utiles/RepGramatical");
%}
...
OBJETO:
      lt identifier LATRIBUTOS gt OBJETOS           lt div identifier gt       { $$ = new Objeto($2,'',@1.first_line, @1.first_column,$3,$5); RepGramatical.append(Objeto, $$);}
    | lt identifier LATRIBUTOS gt LISTA_ID_OBJETO   lt div identifier gt       { $$ = new Objeto($2,$5,@1.first_line, @1.first_column,$3,[]); RepGramatical.append(Objeto, $$);}
    | lt identifier LATRIBUTOS div gt                                          { $$ = new Objeto($2,'',@1.first_line, @1.first_column,$3,[]); RepGramatical.append(Objeto, $$);}
;
...
ATRIBUTO: 
    identifier asig StringLiteral                   { $$ = new Atributo($1, $3, @1.first_line, @1.first_column); RepGramatical.append(Objeto, $$);}
;
