...
exports.MultiplicacionXQ = void 0;
...
var MultiplicacionXQ = /** @class */ (function (_super) {
    __extends(MultiplicacionXQ, _super);
    function MultiplicacionXQ(izq, der, l, c) {
    ...
    MultiplicacionXQ.prototype.getValor = function (ent) {
    ...
    MultiplicacionXQ.prototype.copiar = function () {
        return new MultiplicacionXQ(this.hI.copiar(), this.hD.copiar(), this.linea, this.columna);
    };
    return MultiplicacionXQ;
