...
module.exports.getTipoById = getTipoById;
...
module.exports.Colision = Colision;
...
module.exports.ColisionTipo = ColisionTipo;

const ColisionLogical = 
[
  [Tipo.ERROR,    Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR  , Tipo.ERROR],
  [Tipo.ERROR,    Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR  , Tipo.ERROR],
  [Tipo.ERROR,    Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR,   Tipo.ERROR, Tipo.ERROR  , Tipo.ERROR],
...
module.exports.ColisionLogical = ColisionLogical;

const TipoPath = {
    "ABS" : "absoluto",
    "REL" : "relativo"
}
module.exports.TipoPath = TipoPath;
...
module.exports.Comando = Comando;
...
module.exports.Predicado = Predicado;

function concatenarNodos(principales,secundarios)
{
...
module.exports.concatenarNodos = concatenarNodos;

function concatenarNodosOrden(principales,secundarios)
{
  var nuevoRetorno = []
  var iSec = 0
...
module.exports.concatenarNodosOrden = concatenarNodosOrden;