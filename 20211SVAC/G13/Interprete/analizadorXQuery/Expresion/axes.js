const { Tipo, TipoPath, concatenarNodos, concatenarNodosOrden , Predicado } = require("../AST/Entorno")
const { Nodo } = require("./Expresiones");
...
module.exports.Descendant = Descendant;

class Attribute extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.DescSelf = DescSelf;

class FollowSibling extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.FollowSibling = FollowSibling;

class Follow extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
class CaminoInverso extends Axes
{  
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.CaminoInverso = CaminoInverso;

class Parent extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
class AncestorSelf extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.AncestorSelf = AncestorSelf;

class PrecedingSibling extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.PrecedingSibling = PrecedingSibling;

class Preceding extends Axes
{
  constructor(nombre,predicado,tipo)
  {
    super(nombre,predicado,tipo)
...
module.exports.Preceding = Preceding;