const { concat, pad, truncate } = require("lodash")
const { Tipo, TipoPath, Predicado } = require("../AST/Entorno")
const { Camino } = require("./axes")
const { Literal, Nodo } = require("./Expresiones")
...
// CONTEXT
class ContextItemExpr extends PostFix
{
  constructor(predicado,tipo)
  {
    super(predicado,tipo)
...
module.exports.ContextItemExpr = ContextItemExpr;
...
//CALLFUNCTION
class CallFunction extends PostFix 
{
...
class Position extends PostFix 
{
  constructor (predicado, tipo) {
    super(predicado, tipo)
  }
